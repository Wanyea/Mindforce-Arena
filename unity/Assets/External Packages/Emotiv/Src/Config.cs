namespace EmotivUnityPlugin
{
    ...
    public static class Config
    {
        ...
        public static string AppClientId            = "YIigrmQjG2DGrTt4NHa48ETSRVOplAPHfyygSm7E";
        public static string AppClientSecret        = "XfaaHTZqdRJVxlKZcqQZZ9HYdT9OtVtO4SV58Vws5Lh7TTVZrB9DIqSGUHtfRGVvOHcp87ROTkhQo9C0PWuPQWydOqb7A5f8GIynNXzzwkfpiiENHT4ywxcqXwL8QWNt";

         public static string AppUrl                 = "wss://localhost:6868"; // default
        public static string AppVersion             = "1.0.0"; // default
        public static string AppName                = "MindforceArenaPC"; 
        
        /// <summary>
        /// Name of directory where contain tmp data and logs file.
        /// </summary>
        public static string TmpAppDataDir          = "MindflexArena";
